...
<div class="main-wrapper py-4">
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h2 class="fw-bold mb-0">Add Shipping Zone</h2>
                <small class="text-muted">Create a new shipping zone</small>
            </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="rate" class="form-control" step="0.01" min="0"
                                   value="{{ old('rate', '1') }}" required placeholder="e.g. 1.2">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="free_above" class="form-control" step="0.01" min="0"
                                   value="{{ old('free_above') }}" placeholder="e.g. 5000">
